...
class SuperAdministrator implements UserInterface, PasswordAuthenticatedUserInterface, \Stringable
{
    use HasIdTrait;
    ...
    private array $roles = [HasRoles::DEFAULT, HasRoles::ADMINAPPLICATION];
