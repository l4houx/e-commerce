...
use App\Form\HelpCenterArticleFormType;
...
class HelpCenterArticleController extends AbstractController
{
    ...
    public function index(Request $request, PaginatorInterface $paginator): Response
    {
        ...
        $rows = $paginator->paginate($this->settingService->getHelpCenterArticles(['keyword' => $keyword, 'isOnline' => 'all', 'sort' => 'updatedAt', 'order' => 'DESC']), $request->query->getInt('page', 1), HasLimit::HELPCENTERARTICLE_LIMIT, ['wrap-queries' => true]);
    ...
    */
    ...
    public function newedit(Request $request, ?string $slug = null): Response
    {
        ...
        $form = $this->createForm(HelpCenterArticleFormType::class, $article)->handleRequest($request);
    ...
    #[Route(path: '/articles/{slug}', name: 'view', methods: ['GET'], requirements: ['slug' => Requirement::ASCII_SLUG])]
    public function view(HelpCenterArticle $article): Response
    {
        return $this->render('dashboard/admin/helpCenter/articles/view.html.twig', compact('article'));
    }
