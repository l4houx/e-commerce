...
use App\Form\HelpCenterCategoryFormType;
...
class HelpCenterCategoryController extends AbstractController
{
    ...
    public function index(Request $request, PaginatorInterface $paginator): Response
    {
        ...
        $rows = $paginator->paginate($this->settingService->getHelpCenterCategories(['keyword' => $keyword, 'isOnline' => $isOnline, 'order' => 'c.createdAt', 'sort' => 'DESC']), $request->query->getInt('page', 1), HasLimit::HELPCENTERCATEGORY_LIMIT, ['wrap-queries' => true]);
    ...
    */
    ...
    public function newedit(Request $request, ?string $slug = null): Response
    {
        ...
        $form = $this->createForm(HelpCenterCategoryFormType::class, $category)->handleRequest($request);
    ...
    #[Route(path: '/categories/{slug}', name: 'view', methods: ['GET'], requirements: ['slug' => Requirement::ASCII_SLUG])]
    public function view(HelpCenterCategory $category): Response
    {
        return $this->render('dashboard/admin/helpCenter/category/view.html.twig', compact('category'));
    }
